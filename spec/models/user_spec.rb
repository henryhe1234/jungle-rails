...
RSpec.describe User, type: :model do
  describe 'Validations' do
    ...
    it "validate the password" do
      @user = User.new(:first_name => "Henry",:last_name =>"He",:email => "a@a.com",:password => "12345",:password_confirmation => "12345")
      @user.save
    ...
    it "validate the password and be invalid when password does not match " do
      @user1 = User.new(:first_name => "Henry",:last_name =>"He",:email => "b@b.com",:password => "12345",:password_confirmation => "123456")
      @user1.save
    ...
    it "validate the email " do
      @user2 = User.new(:first_name => "Henry",:last_name =>"He",:email => "c@c.com",:password => "12345",:password_confirmation => "12345")
      @user2.save
      @user2_5 = User.new(:first_name => "Henry",:last_name =>"He",:email => "C@C.com",:password => "12345",:password_confirmation => "12345")
      @user2_5.save
    ...
    it "validate the first_name " do
      @user4 = User.new(:first_name => "Henry",:email => "e@e.com",:password => "12345",:password_confirmation => "12345")
      @user4.save
    ...
    it "validate the eamil to presense " do
      @user5 = User.new(:first_name => "Henry",:last_name =>"He",:password => "12345",:password_confirmation => "12345")
      @user5.save
    ...
    it "validate password's length " do
      @user6 = User.new(:first_name => "Henry",:email => "f@f.com",:last_name =>"He",:password => "1234",:password_confirmation => "1234")
      @user6.save
